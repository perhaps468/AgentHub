...
import type{ LoginResponse, CodeResponese, RegisterResponese ,LoginData} from '../types/login';
...
export const getCode = (data: any) =>Http.get('/api/v1/common/get-code', data)
